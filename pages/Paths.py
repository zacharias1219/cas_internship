...
def bot_conversation(data, question_number):
    ...
    st.write("Status: waiting for you to speak (click the button)")
    key_counter += 1
    ...
    if audio_data:
        ...
        st.write("Status: analyzing...")
        # Assume follow_up_question is generated by a language model based on the conversation history
