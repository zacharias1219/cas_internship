...
st.subheader("Start by selecting a situation and clicking on the record button to speak. Once you're done with your session, say goodbye and click on end session to reset.", divider="rainbow")
